        ...
        <div class="credit-card-field-icon-wrapper marker02">
          <div class="credit-card-field-icon-card marker03">
            <div class="credit-card-field-icon-front marker04">
              ...
              <icon :icon="['fab', 'cc-mastercard']" data-brand="mastercard" class="credit-card-field-icon marker-icon" />
              <icon :icon="['fab', 'cc-diners-club']" data-brand="dinersclub" class="credit-card-field-icon marker-icon" />
              <icon :icon="['far', 'credit-card']" data-brand="unknown" class="credit-card-field-icon marker-icon" width="20"
                height="18" />
            </div>
